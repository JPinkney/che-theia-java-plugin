...
import { JarFolderNode } from './jar-folder-node';
...
export class JarNode implements CompositeTreeNode {
    ...
    public async resolveChildren(jc: ILanguageClient, projectUri: string): Promise<Array<TreeNode>> {
