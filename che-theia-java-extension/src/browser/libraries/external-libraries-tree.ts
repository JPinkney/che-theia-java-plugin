...
import { CompositeTreeNode, TreeNode, SelectableTreeNode, ExpandableTreeNode, TreeImpl } from '@theia/core/lib/browser';
...
@injectable()
export class ExternalLibrariesTree extends TreeImpl {
